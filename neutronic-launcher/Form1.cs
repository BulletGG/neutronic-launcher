...

{
    public partial class Form1 : MaterialForm
    {
        ...
        private void Form1_Load(object sender, EventArgs e) //form loaded 
        {
            ...
            materialLabel6.Text = new WebClient().DownloadString("https://pastebin.com/raw/2qKGEwd9"); //change this link to what text u want to show in the updates tab, this pastebin is example
